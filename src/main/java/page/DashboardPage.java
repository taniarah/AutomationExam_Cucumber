...
public class DashboardPage {
	...
	public void clickOnSkyBlueBackGroundElement() {
	...
	public String getBackgroundColor() {
		/*
		 * String bgColor = BODY_ELEMENT.getCssValue("background-color");
		 * 
		 * return bgColor;
		 */
	...
	public String getBlueButtonText() {
		...
		return SET_BLUE_BUTTON.getText();
	}

	public String getWhiteButtonText() {

		return SET_WHITE_BUTTON.getText();
	}

	public void clickOnWhiteBackGroundElement() {
